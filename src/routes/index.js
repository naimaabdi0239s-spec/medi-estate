...
function Nav() {
    return (<header className="absolute top-0 left-0 right-0 z-30 px-6 md:px-12 py-6 flex items-center justify-between">
...
function Hero() {
    ...
    return (<section className="relative min-h-screen w-full overflow-hidden">
      <video src={heroVideo.url} autoPlay loop muted playsInline className="absolute inset-0 h-full w-full object-cover"/>
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center text-center px-6 pt-28 pb-16" style={{ color: "#F2E4CC" }}>
        ...
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl leading-[1.02] max-w-5xl">
          {headline.map((w, i) => (<span key={i} className="hero-word mr-3" style={{ animationDelay: `${0.15 + i * 0.12}s` }}>
              {w}
            </span>))}
        </h1>
...
function Categories() {
    ...
    return (<section id="categories" ref={ref} className="py-10 px-6" style={{ background: "#F2E4CC" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {cats.map((c) => (<a key={c.name} href="#properties" className="reveal group block relative overflow-hidden">
...
function About() {
    const ref = useReveal();
    return (<section id="about" ref={ref} className="py-10 px-6" style={{ background: "#F2E4CC" }}>
...
function Featured() {
    const ref = useReveal();
    return (<section id="properties" ref={ref} className="py-10 px-6" style={{ background: "#E8D6AE" }}>
      <div className="max-w-7xl mx-auto">
...
function Why() {
    ...
    return (<section ref={ref} className="py-10 px-6" style={{ background: "#F2E4CC" }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {items.map((it) => (<div key={it.num} className="reveal p-6 border" style={{ borderColor: "rgba(27,75,102,0.18)", background: "rgba(242,228,204,0.4)" }}>
...
function Gallery() {
    ...
    return (<section id="gallery" ref={ref} className="py-10 px-6" style={{ background: "#F2E4CC" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {shots.map((s) => (<figure key={s.label} className={`reveal overflow-hidden relative ${s.cls}`}>
...
function Testimonials() {
    ...
    return (<section id="testimonials" ref={ref} className="py-10 px-6" style={{ background: "#E8D6AE" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((t, i) => (<figure key={i} className="reveal p-6 relative border-l-2" style={{ borderColor: "#C1502E", background: "rgba(242,228,204,0.5)" }}>
...
function Choice({ options, value, onChange }) {
    return (<div className="flex flex-wrap gap-2">
      {options.map((o) => {
            ...
            return (<button type="button" key={o} onClick={() => onChange(o)} className="px-4 py-2 text-xs tracking-wide transition-colors" style={{
                    borderRadius: 999,
...
function Contact() {
    ...
    return (<section id="contact" ref={ref} className="py-10 px-6" style={{ background: "#F2E4CC" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="reveal mt-6 overflow-hidden border" style={{ borderColor: "rgba(27,75,102,0.2)" }}>
          <iframe title="Medi Estate office map" src="https://www.openstreetmap.org/export/embed.html?bbox=55.22%2C25.19%2C55.27%2C25.22&layer=mapnik&marker=25.205%2C55.245" className="w-full h-[320px]" style={{ filter: "sepia(0.15) hue-rotate(-10deg) saturate(0.85)", border: 0 }} loading="lazy"/>
        </div>
      </div>
    </section>);
}
