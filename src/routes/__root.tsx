...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Medi Estate — The Leading Real Estate Company in the UAE" },
      ...
      { property: "og:title", content: "Medi Estate — Where the Mediterranean Meets the Gulf" },
      { property: "og:description", content: "Beachfront villas, penthouses, and coastal homes across the UAE." },
