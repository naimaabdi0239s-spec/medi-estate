...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Medi Estate — The Leading Real Estate Company in the UAE" },
      ...
      { name: "twitter:title", content: "Medi Estate — The Leading Real Estate Company in the UAE" },
